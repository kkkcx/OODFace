...
def align(img, image_size=(112,112)):
    ...
    bounding_boxes, points = detect_face(img, _minsize, pnet, rnet, onet, threshold, factor)
    ...
    warped, M = preprocess(img, image_size=image_size, bbox=_bbox, landmark = _landmark)
